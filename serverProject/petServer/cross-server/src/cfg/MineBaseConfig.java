...
public class MineBaseConfig extends baseConfig<MineBaseConfigObject> {
    ...
    public static Map<Integer, MineBaseConfigObject> _ix_type = new HashMap<Integer, MineBaseConfigObject>();
    ...
    public void putToMem(Map e, MineBaseConfigObject config) {
        ...
        config.setRewardlist(MapHelper.getIntArray(e, "RewardList"));
