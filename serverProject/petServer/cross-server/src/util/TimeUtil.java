...
public class TimeUtil {
    ...
    public static void main(String[] args){
        System.out.println(new Date(getNextDayResetTime(System.currentTimeMillis(),30)));
    }
    ...
    public static long getNextDayResetTime(long timeStamp) {
        GameConfigObject gameCfg = GameConfig.getById(GameConst.ConfigId);
        if (gameCfg == null) {
     ...
     * 获取下次的统一刷新时间
     */
    public static long getNextDayResetTime(long timeStamp, int days) {
        long todayStamp = getTodayStamp(System.currentTimeMillis());
        return todayStamp;
    }
