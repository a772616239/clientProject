...
public class MistTreatGrid extends MistGridObj {
    public MistTreatGrid(MistRoom room, int objType) {
        super(room, objType);
    }
    ...
    public void beTouch(MistFighter fighter) {
        ...
        fighter.getSkillMachine().triggerPassiveSkills(MistSkillTiming.TouchTreatGrid, fighter, null);
        dead();
    }
}
