...
public class MistChaoticGrid extends MistGridObj {
    public MistChaoticGrid(MistRoom room, int objType) {
        super(room, objType);
    }
    ...
    public void beTouch(MistFighter fighter) {
        ...
        fighter.getSkillMachine().triggerPassiveSkills(MistSkillTiming.TouchChaoticGrid, fighter, null);
