...
//    static ExecutorService pool = Executors.newCachedThreadPool();
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        try {
            ...
            LogUtil.debug("recv msg id=" + MsgIdEnum.forNumber(msgId));
            ...
            chn.getAutoDrivenActionQueue().add(new Runnable() {
                ...
                public void run() {
                    ...
                    if (msgId != MsgIdEnum.GS_CS_MistForestRoomInfo_VALUE && costTime > 100) {
    ...
    public void close(ChannelHandlerContext ctx) {
        ...
        if (chn != null) {
            ...
            GlobalData.getInstance().removeServerChannel(serverIndex);
            LogUtil.error("Server closed addr:" + ip);
            chn.close();
        }
