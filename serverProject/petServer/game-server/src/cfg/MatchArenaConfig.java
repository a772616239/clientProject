...
config.setMatchtimescope(MapHelper.getIntArray(e, "matchTimeScope"));

config.setTimescope(MapHelper.getIntArray(e, "timeScope"));

config.setGaingiftpro(MapHelper.getInt(e, "gainGiftpro"));

config.setMatchwinreward(MapHelper.getInts(e, "matchWinReward"));

config.setMatchfailedreward(MapHelper.getIntArray(e, "matchFailedReward"));
