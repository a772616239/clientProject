...
public class TheWarSeasonConfigObject implements baseConfigObject {
    ...
    public int getRewardIdByRank(int campRank) {
        if (seasoncamprankreward == null) {
            return 0;
        }
        Integer rewardId = seasoncamprankreward.get(campRank);
        return rewardId != null ? rewardId : 0;
    }
}
