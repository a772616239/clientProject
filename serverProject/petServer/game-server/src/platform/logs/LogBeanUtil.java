...
public class LogBeanUtil {
    ...
    public static <T> Set<Class<T>> findSubClazzFromFile(String packageName, String packagePath, boolean recursive, Class<T> parentClass) {
