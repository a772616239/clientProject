...
public class BossTowerConfig extends baseConfig<BossTowerConfigObject> {
    ...
    public static Map<Integer, BossTowerConfigObject> _ix_id = new HashMap<Integer, BossTowerConfigObject>();
    ...
    public static BossTowerConfigObject randomGet() {
        ArrayList<BossTowerConfigObject> bossTowerConfigObjects = new ArrayList<>(_ix_id.values());
        return bossTowerConfigObjects.get(new Random().nextInt(bossTowerConfigObjects.size()));
    }
}
