...
@MsgId(msgId = MsgIdEnum.SC_QueryWarGridList_VALUE)
public class ResQueryWarGridListHandler extends AbstractHandler<SC_QueryWarGridList> {
    @Override
    protected SC_QueryWarGridList parse(byte[] bytes) throws Exception {
        return SC_QueryWarGridList.parseFrom(bytes);
    }

    @Override
    protected void execute(GameServerTcpChannel gsChn, SC_QueryWarGridList ret, int i) {
